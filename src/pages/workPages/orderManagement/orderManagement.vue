<template>
  <div id="orderManagement">
    ...
    <div class="button-top">
      <mt-button type="default" :style="topButCss" :class="{ isSelected: selectButton }" @click="chooseOrder(1)">普通订单</mt-button>
      <mt-button type="default" :style="topButCss" :class="{ isSelected: !selectButton }" @click="chooseOrder(3)">代客订单</mt-button>
    </div>
    ...
    <div class="mint-tab-container" ref="homePage">
      <myAllOrder ref="myAllOrder" :searchTxtFar="searchTxt" :isBack="isBack" :OrderTypeN="orderType" v-if="selected == '1'"></myAllOrder>
      ...
      <searchOrder :searchTxtFar="searchTxt" :OrderTypeN="orderType" v-if="searchBtn && selected == '6'"></searchOrder>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    changeFixed(clientHeight) {
      if (document.querySelector('.mint-navbar') && document.querySelector('.search') && document.querySelector('.button-top')) {
        let height_ =
