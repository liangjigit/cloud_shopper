  ...
  <div class="container_filtering">
    <div class="searchBox">
      <form method="post" class="search" id="search" @submit.prevent="submit">
        <input type="text" name id="searchBar" value v-model="searchValue" results="5" placeholder="输入手机号或会员卡号" class="searchBar" />
          ...
          <template>
            <li @click="judgePage" v-if="hasCustomers">
              ...
              <div class="memberData">
                <span class="memberName">{{searchCustomers.name}}</span>
